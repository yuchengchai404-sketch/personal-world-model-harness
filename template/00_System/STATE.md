...
1. Load `model-promotion.md` as the primary Skill.
2. Check origin, reasoning, boundary, relation, and retrieval value.
3. Update this STATE after the decision.

## Last Handoff

- completed: Source-bound Note created
- unresolved: Candidate has not passed Insight Gate
- resume_with: Review the counterexample
